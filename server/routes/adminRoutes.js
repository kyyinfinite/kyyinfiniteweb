...
const { getMetrics, getMetricsTimeseries, listOrders, listPanels, setContributorVerified } = require('../controllers/adminController');
...
router.patch('/users/:uid/verify', adminAuthMiddleware, setContributorVerified);
