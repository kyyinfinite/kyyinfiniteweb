...
// Visual redesign to the "soft modern digital studio" light theme is complete —
// every route below renders its own light background. (Previously this had a
// LegacyDarkShell wrapper for pages not yet migrated; no longer needed.)
